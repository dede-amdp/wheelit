        ...
        child: Container(
          child: Column(
            children: <Widget>[
              ...
              RichText(
                  text: TextSpan(
                      text: 'Benvenuto su ', style: TextStyle(
                      fontSize: 25.0,
              ...
              Text("L'app per la smart mobility",
                style: TextStyle(
                    fontSize: 20.0,
                    color:Colors.black
                ),
              ...
              SignInButton(
                ...
                onPressed: () => {signInWithGoogle().then((user) => navigateToHomeScreen()) }
                ),
            ],
          ),
        ),
